...
public class WindowsUpstairsAsyncTask extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        ...
        URL url = null;
        try {
            url = new URL("https://ninersense.mybluemix.net/windowupstairs.php");
            HttpsURLConnection urlConnection = (HttpsURLConnection) url.openConnection();
            String data = "windowupstairs=" + str;
