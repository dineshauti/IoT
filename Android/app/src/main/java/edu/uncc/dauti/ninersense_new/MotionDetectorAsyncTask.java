...
public class MotionDetectorAsyncTask extends AsyncTask<String, Void, String> {
    @Override
    protected String doInBackground(String... params) {
        ...
        URL url = null;
        try {
            url = new URL("https://ninersense.mybluemix.net/motiondetector.php");
            HttpsURLConnection urlConnection = (HttpsURLConnection) url.openConnection();
            String data = "motiondetector=" + str;
