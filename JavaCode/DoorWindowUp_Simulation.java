...
public class DoorWindowUp_Simulation implements Runnable{
	...
	public void run() {
		...
		while(true)
		{
			...
			try{
				...
				PreparedStatement prep = con.prepareStatement("SELECT door_status FROM windowupstairs");
				...
				if (currentStatus != door2.getDoorStatus())
				{
					if (door2.getDoorStatus() == 1)
						System.out.println("Upstair Window Open");
					else
						if (door2.getDoorStatus() == 0)
							System.out.println("Upstair Window Closed");
